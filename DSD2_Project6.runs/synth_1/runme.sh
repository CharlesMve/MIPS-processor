...
HD_PWD='C:/Users/Jean-Charles Mve/Documents/DSD2 Hw/DSD2_Project6/DSD2_Project6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log micro_procHW.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source micro_procHW.tcl
