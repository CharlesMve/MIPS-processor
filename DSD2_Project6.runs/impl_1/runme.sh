...
HD_PWD='C:/Users/Jean-Charles Mve/Documents/DSD2 Hw/DSD2_Project6/DSD2_Project6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log micro_procHW.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source micro_procHW.tcl -notrace
